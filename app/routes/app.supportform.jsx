...
//     {
//       label: "DS-Cart Drawer Progress Bar",
//       value: "ds-cart-drawer-progress-bar",
//     },
//     { label: "DS-Offer With Copy Code", value: "ds-Offer-with-copy-code" },
//     { label: "DS-Recent View Products", value: "ds-recent-view-products" },
//     {
//       label: "DS-Whatsapp Floating Button",
//       value: "ds-whatsapp-floating-button",
//     },
...
//                     {
//                       value: "cart&cartdrawer page",
//                       label: "Cart & Cartdrawer page",
//                     },
...
//   let mailOptions = {
//     from: `"Support Form" <support@digisidekick.com>`,
//     to: "vikasprasad2903@gmail.com", 
...
//                   {/* Hidden fields for OptionList selections */}
...
//     cc: "suraj@digisidekick.com", // added CC as you asked
//     subject: `New Support Request from ${shop}`,
//     text: JSON.stringify(formDetails, null, 2),
//   };
...
export default function SupportApp() {
  ...
  useEffect(() => {
    ...
    if (window.location.search.includes("success=true")) {
      ...
      navigate("/app/thankyou", { replace: true });
    }
  }, []);
